...
export default function BackgroundBlue({ className = "", isMyTurn = true }: BackgroundBlueProps) {
  return (
    <div
      className={`absolute inset-0 background-layer ${className}`}
      style={{
        background: 'radial-gradient(circle at center, rgba(30, 58, 138, 0.6) 0%, rgba(17, 24, 39, 0.8) 50%, rgba(0, 0, 0, 1) 100%)',
        zIndex: 0,
        pointerEvents: 'none'
      }}
    >
