          ...
          <div className="relative z-10 flex flex-col items-center gap-8 px-4">
            ...
            <div className="glass-menu-card animate-fade-in px-0 my-0 relative z-10">
              ...
              <div className="flex flex-col gap-4 min-w-[320px] relative z-10">
                <Button size="lg" className="bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white font-bold shadow-lg hover:shadow-xl transition-all duration-300 group py-8" onClick={handlePlayClick}>
